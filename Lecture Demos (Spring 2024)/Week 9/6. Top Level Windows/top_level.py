...
class Application:
    ...
    def setup_buttons(self):
        frame = Frame(self.root)
        Button(frame, text="Secret", foreground="white", background="blue", relief=FLAT, font="Arial 10 bold", command=self.secret).pack(side=LEFT, fill=X, expand=True)
    ...
    def secret(self):
        secret = Toplevel()
        lbl = Label(secret, text="new Window!!")
        lbl.pack()
