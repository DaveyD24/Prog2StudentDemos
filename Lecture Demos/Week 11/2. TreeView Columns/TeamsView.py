...
class TeamsView:
    ...
    def control(self):
        self.tree = ttk.Treeview(self.window, columns=("locCol", "nameCol", "winPercentCol"), show="headings", selectmode=BROWSE)
        ...
        ut.Button(self.window, "Select", self.select).pack(expand=True, fill=X)
